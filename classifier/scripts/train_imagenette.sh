...
# CUDA_VISIBLE_DEVICES=0 python train_imagenette_clf_trigger.py --poison clean --n_epoch 1
# CUDA_VISIBLE_DEVICES=0 python train_imagenette_clf_trigger.py --poison badnet --n_epoch 1
# CUDA_VISIBLE_DEVICES=0 python train_imagenette_clf_trigger.py --poison blend --n_epoch 1
# CUDA_VISIBLE_DEVICES=0 python train_imagenette_clf_trigger.py --poison bomb --n_epoch 1
