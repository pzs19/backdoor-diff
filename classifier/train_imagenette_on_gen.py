...
parser.add_argument("--model_dir", default=f'model_ckpt/imagenette_on_gen', type=str)
parser.add_argument("--res_dir", default=f'result/imagenette_on_gen', type=str)
...
if 'sample' in args.poison:
    trainset = NpzImagenette(args.data_path, transform=transform_train, prompts_file=osp.join(osp.dirname(args.data_path), "prompts_all.txt"))
elif 'trainset' in args.poison:
    trainset = FolderImagenette(args.data_path, transform=transform_train)
